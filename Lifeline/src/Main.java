...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to your thing");
        ...
        if(cls.equals("1")) {
            ...
            System.out.println("You turn of your comm system because you don't feel like dealing with this scrub");
            System.exit(0);
        }
        ...
        System.out.println("I think I got hit in the head because I've got a splitting headache and no idea how I got here");
        System.out.println("There's debre everywhere from what looks like a plane crash.");
        System.out.println("I think I remember being in the plane, and I don't know if anyone else made it...");
        System.out.println(" ");
        ...
        if(ans2.equals("1")) {
            ...
            System.out.println(" ");
            System.out.println("When I woke up, there was a bunch of debre from the crash. I found this comms device... I think its waterproof.");
        }
        ...
        System.out.println(" ");
        System.out.println("Listen, I need your help. I don't know where I am or what I'm going to do.");
        ...
        if(ans3.equals("1")) {
            ...
            System.out.println(" ");
            System.out.println("If I make it off this island, I'll do whatever I can to make it worth your time.");
        ...
        //User name
        System.out.println("If you're going to be helping me make it through this, I guess I should know your name?");
        System.out.println(" ");
        ...
        if(wp.equals("sword")) {
            ...
            System.out.println("suprise bitch! The spoon is enchanted or some shit so it is strong af ;)");
            weap = 3;
            mag = 2;
        }
            ...
            System.out.println(user + " was caught trying to steal from the merchant and was attacked. You didn't make it.");
            System.exit(0);
        }
        ...
        if(att == 2) {
            ...
            System.out.println("You don't know how to use your new magic spoon so you just close your eyes and wave it around.");
            System.out.println("You open your eyes to see that your magic spoon has turned the homie into a chicken, poor guy.");
        }
        else {
            System.out.println(user + " waved his hands around and peed a little. He ran away, tripped and fell into a spike pit... THE END.");
            System.exit(0);
